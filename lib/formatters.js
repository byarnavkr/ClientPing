...
export function getStatusStyle(status) {
  const map = {
    new:       { label: 'New',       bg: '#E1F5EE', color: '#085041' },
    contacted: { label: 'Contacted', bg: '#FAEEDA', color: '#633806' },
    qualified: { label: 'Qualified', bg: '#E6F1FB', color: '#0C447C' },
    closed:    { label: 'Closed',    bg: '#EAF3DE', color: '#27500A' },
    lost:      { label: 'Lost',      bg: '#FCEBEB', color: '#501313' },
  }
