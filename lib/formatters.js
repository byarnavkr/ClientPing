...
export function getStatusBadge(status) {
  const map = {
    'new lead':   { label: 'New Lead',   dot: 'bg-blue-500',    badge: 'bg-blue-50 text-blue-700 border-blue-100/50' },
    interested:   { label: 'Interested',  dot: 'bg-amber-500',   badge: 'bg-amber-50 text-amber-700 border-amber-100/50' },
    client:       { label: 'Client',      dot: 'bg-emerald-500', badge: 'bg-emerald-50 text-emerald-700 border-emerald-100/50' },
